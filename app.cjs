// Production server for Azure deployment - CommonJS version
...
// Special route for transactions page
app.get('/transactions', ensureAuthenticated, (req, res) => {
  res.sendFile(path.join(__dirname, 'server/public/add-transaction.html'));
});
